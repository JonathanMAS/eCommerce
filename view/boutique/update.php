<main id="mainEditeProduit">
    ...
    <div id="lienRetour">
        <a href="index.php?controller=produit&action=readAll"> << Retour </a>
    </div>
    
    <form method="post" action="index.php?controller=produit&action=updated" enctype="multipart/form-data">
        <div>
            <h3><?php echo $formTitle ?> un produit</h3>
